...
print_header() {
  echo ""
  echo "============================================"
  echo "  RAG OpenClaw Setup (Direct Access)"
  echo "============================================"
  echo ""
}
...
echo "-- Step 1/4: Environment Variables --"
echo ""
...
echo ""
echo "-- Step 2/4: Generating OpenClaw Gateway Token --"
echo ""
...
echo ""
echo "-- Step 4/4: SSH Key Generation --"
echo ""
...
echo "  sh-openclaw"
echo ""
echo "  (or: docker exec -it rag-openclaw-direct bash)"
echo ""
echo "-- Connect via gateway --"
echo ""
